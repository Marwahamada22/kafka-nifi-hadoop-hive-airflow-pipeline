...
public class UserEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7912943588361566215L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserEvent\",\"namespace\":\"com.example.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"event_time\",\"type\":\"long\"}]}");
   ...
   */
  public UserEvent(java.lang.Integer id, java.lang.CharSequence name, java.lang.CharSequence email, java.lang.Long event_time) {
    this.id = id;
    this.name = name;
    this.email = email;
   ...
   */
  public static com.example.avro.UserEvent.Builder newBuilder() {
    return new com.example.avro.UserEvent.Builder();
  }
   ...
   * @return A new UserEvent RecordBuilder
   */
  public static com.example.avro.UserEvent.Builder newBuilder(com.example.avro.UserEvent.Builder other) {
    if (other == null) {
      return new com.example.avro.UserEvent.Builder();
    } else {
      return new com.example.avro.UserEvent.Builder(other);
    }
  }
   ...
   * @return A new UserEvent RecordBuilder
   */
  public static com.example.avro.UserEvent.Builder newBuilder(com.example.avro.UserEvent other) {
    if (other == null) {
      return new com.example.avro.UserEvent.Builder();
    } else {
      return new com.example.avro.UserEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.avro.UserEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.avro.UserEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserEvent.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserEvent.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserEvent.Builder setEventTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserEvent.Builder clearEventTime() {
